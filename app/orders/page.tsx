  ...
  return (
    <div className="min-h-screen bg-white dark:bg-charcoal-900">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-charcoal-900 mb-2">My Orders</h1>
          <p className="text-charcoal-600">Track and manage all your orders</p>
        </div>
        ...
        {filteredOrders.length === 0 ? (
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <h3 className="text-xl font-bold text-charcoal-900 mb-2">No orders found</h3>
            ...
            {filteredOrders.map((order) => {
              ...
              return (
                <div key={order.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="font-bold text-charcoal-900">Order #{order.id}</h3>
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="flex gap-4 overflow-x-auto pb-2">
                      ...
                      {order.itemCount > order.items.length && (
                        <div className="flex-shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-lg border border-dashed border-gray-300 flex items-center justify-center text-charcoal-600">
                  ...
                  {/* Order Actions */}
                  <div className="p-4 sm:p-6 border-t bg-gray-50 flex flex-wrap gap-2">
                    ...
                    {order.status === 'delivered' && (
                      <>
                        ...
                        <button className="px-4 py-2 border-2 border-gray-300 text-charcoal-700 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors">
                          Leave Review
                        </button>
                        <button className="px-4 py-2 border-2 border-gray-300 text-charcoal-700 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors">
                          Return Items
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-charcoal-900 mb-2">Need help with your order?</h3>
