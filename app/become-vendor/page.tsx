...
export default function BecomeVendorPage() {
  ...
  const benefits = [
    ...
    { icon: '💰', title: 'Low Fees', description: 'Just 5% seller commission per sale — no fees charged to buyers. Flutterwave payment processing costs are absorbed by the platform and never passed to you.' },
